...
OUTPUT_NAME="/Users/ma/data/apk/xchat.apk"
# 只打 arm64，产物为 app-release.apk，复制到桌面并重命名为 xchat.apk
[ -f "$APK_DIR/app-release.apk" ] && cp "$APK_DIR/app-release.apk" "$OUTPUT_NAME" && echo "已复制到: $OUTPUT_NAME"
echo ""
