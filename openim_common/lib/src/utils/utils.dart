        ...
        case MessageType.custom:
          {
            ...
            var customType = map['customType'];
            if (map['type'] == 'RedPacket') {
              bool isOpen = message.exMap['redPacketStatus'] == 'opened';
              if (!isOpen &&
                  message.localEx != null &&
                  message.localEx!.isNotEmpty) {
                try {
                  final local = json.decode(message.localEx!);
                  if (local['redPacketStatus'] == 'opened') isOpen = true;
                } catch (_) {}
              }
              return {
                'viewType': 'RedPacket',
