const Map<String, String> zh_CN = {
  ...
  "invitationCode": "上级ID",
  "plsEnterInvitationCode": "请输入上级ID%s",
  "optional": "选填",
  "nextStep": "下一步",
  ...
  'pinMessage': '置顶消息',
  'unpinMessage': '取消置顶消息',
  'menuDoubleDelete': '双向删除',
  'confirmDoubleDeleteMessage': '确认双向删除这条消息吗？',
  'pinnedMessage': '置顶消息',
  'markHasRead': '标记已读',
  'delete': '删除',
  'nPieces': '%s条',
  ...
  'canNotAddYourselfAsFriend': '不能添加自己为好友',
  'friendApplicationBlocked': '你已被对方拉黑，无法发送好友申请',
  'alreadyAFriendRelationship': '已经是好友，无需重复申请',
  'noPermissionToAddFriend': '暂无权限发送好友申请',
  "mutedAll": "全体禁言",
  "tenMinutes": "10分钟",
  "oneHour": "1小时",
  "twelveHours": "12小时",
