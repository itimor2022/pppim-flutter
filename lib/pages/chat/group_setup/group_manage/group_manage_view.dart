    ...
    return Scaffold(
      ...
      body: Obx(() => Column(
            children: [
              ...
              _buildItemView(
                text: '本群账单明细',
                onTap: logic.viewGroupBills,
                showRightArrow: true,
                isTopRadius: true,
              ),
              _buildItemView(
                text: '发包金额赔率配置',
                onTap: logic.configSweepMine,
                showRightArrow: true,
              ),
              _buildItemView(
                text: '扫雷功能设置 (功能开关/免死号)',
                onTap: logic.configGroupMineSetting,
                showRightArrow: true,
              ),
              _buildItemView(
                text: '机器人高级设置',
                onTap: logic.configRobot,
                showRightArrow: true,
              ),
              _buildItemView(
                text: '特殊触发奖励配置 (按规则)',
                onTap: logic.configSpecialReward,
                showRightArrow: true,
                isBottomRadius: true,
              ),
            ],
