...
import '../../RedPacket/RedPacketRecordsController.dart';
import '../../RedPacket/WalletBalancePage.dart';
import '../../RedPacket/WalletBalanceController.dart';
import '../../RedPacket/SetPayPasswordPage.dart';
import '../../RedPacket/SetPayPasswordController.dart';
import '../../RedPacket/ResetPayPasswordPage.dart';
...
class AppPages {
  ...
  static final routes = <GetPage>[
    ...
    GetPage(
      name: AppRoutes.redPacketSend,
      page: () => RedPacketSendPage(),
      binding: BindingsBuilder(() {
        Get.lazyPut(() => RedPacketSendController());
      }),
    ),
    GetPage(
      name: AppRoutes.redPacketRecords,
      page: () => RedPacketRecordsPage(),
      binding: BindingsBuilder(() {
        Get.lazyPut(() => RedPacketRecordsController());
      }),
    ),
    GetPage(
    ...
    GetPage(
      name: AppRoutes.redPacketRecordList,
      page: () => RedPacketRecordListPage(),
    ),
    GetPage(
